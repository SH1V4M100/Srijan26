...
const ESPORTS_EVENTS: Event[] = [
  ...
  },
  {
    ...
    category: "Esports",
    color: "#FC422D",
    description: "Step onto the digital pitch and showcase your football finesse in the PES Mobile 1v1 LAN Tournament. Every pass, tackle, and goal decides your fate.",
    format: "Offline",
    teamSize: "Individual",
