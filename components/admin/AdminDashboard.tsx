                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <CardDescription className="text-slate-600">
                        Manage and view all registered participants for{" "}
                        {selectedEvent.name}
                      </CardDescription>
                    </div>
                    <Button
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <TabsList className="grid w-full max-w-md grid-cols-3 bg-slate-100 text-slate-700">
                        ...
                        <TabsTrigger value="verified" className="data-[state=active]:bg-white data-[state=active]:text-slate-900">
                          Verified
                        </TabsTrigger>
                        <TabsTrigger value="unverified" className="data-[state=active]:bg-white data-[state=active]:text-slate-900">
                          Unverified
                        </TabsTrigger>
                      </TabsList>
                    </Tabs>
